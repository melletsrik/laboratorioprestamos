...
// Componente de búsqueda de Estudiante
const EstudianteBusqueda = ({ onBuscar }) => {
  ...
  const handleSearch = (e) => {
    ...
    onBuscar(valor); // Llamamos a la función del componente padre para filtrar los Estudiante
  };
...
export default EstudianteBusqueda;
