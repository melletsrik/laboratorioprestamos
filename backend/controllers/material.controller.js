...
exports.create = async (req, res) => {
  ...
  if (!req.body.codigo_material || !req.body.nombre || !req.body.cantidad_total) {
    return res.status(400).json({
      success: false,
      message: 'Faltan campos obligatorios: codigo_material, nombre, cantidad_total'
    });
  }
...
exports.update = async (req, res, next) => {
  try {
    const materialActualizado = await MaterialService.update(req.params.id, req.body);
